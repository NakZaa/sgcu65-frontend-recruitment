...
```
  git clone https://github.com/NakZaa/sgcu65-frontend-recruitment.git
```
...
-สลับ Field ของ Form ลงทะเบียน ให้ Username และ Email ขึ้นก่อน เนื่องจากคิดว่าทำให้กรอกข้อมูลได้ง่ายกว่า

-เพิ่มแถบ List ใน navbar เพื่อความสะดวกในการใช้งาน